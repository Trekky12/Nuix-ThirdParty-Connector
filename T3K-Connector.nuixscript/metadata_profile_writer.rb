...
class MetadataProfileReaderWriter
  ...
  def writeProfile(profile_name, data)
    ...
    if File.exist?(metadataProfilePath)
      ...
      metadataProfileContent << "    </metadata>\n"
      metadataProfileContent << "    <metadata type=\"CUSTOM\" name=\"#{CUSTOM_METADATA_FIELD_NAME}|RAW|Metadata\" />\n"
      metadataProfileContent << "    <metadata type=\"CUSTOM\" name=\"#{CUSTOM_METADATA_FIELD_NAME}|RAW|Detections\" />\n"
