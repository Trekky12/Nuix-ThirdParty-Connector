...
require_relative "t3k_analysisUI.rb"
...
begin
  ...
  connector = T3KConnector.new current_case, current_selected_items, utilities, SETTINGS_FILE
  analysis_frame = T3KAnalysisFrame.new window, SETTINGS_FILE
