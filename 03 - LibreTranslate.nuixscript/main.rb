...
require_relative "libretranslate.rb"
require_relative "libretranslateUI.rb"
...
begin
  ...
  connector = LibreTranslateConnector.new current_case, current_selected_items, utilities, SETTINGS_FILE
  analysis_frame = LibreTranslateFrame.new window, SETTINGS_FILE
